...
The `copy()` function ([reference](https://kotlinlang.org/docs/data-classes.html#copying)) is provided by default to all the instances of data classes. It lets you copy an object and change some of its properties, while keeping the rest of its properties unchanged.
