...
```
Note that `sSL` uses SSL/TLS v1 for establishing the connection and is actually not very secure. Things like ssl-reqd are more secure. ([link](https://curl.se/docs/manpage.html)). <br>
