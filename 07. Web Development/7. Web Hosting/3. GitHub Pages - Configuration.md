...
Every GitHub user/org also gets a user site, all that you need to do is to create a repo with exactly your username in the format `anandkumar9.github.io`, and then it automatically activates Pages in its settings and in a few seconds activates a site of the format `https://anandkumar9.github.io` with the default 'Pages > Source > Build and Deployment' being 'deploy from a branch' and not 'GH Actions'.

Specific repos can still continue to exist with specific domains, and for such the Pages > Source > Build and Deployment is usually 'GH Actions'.

![image-20260423131242474](./assets/image-20260423131242474.png)
