...
The structured metadata about the file at the top is called **Frontmatter** (its probably a more general term and not simply YAML's alone).

```
---
name: Swift Concurrency Auditor
description: Reviews actor isolation and Sendable usage
