...
| Examples                                | C, C++, Swift, Rust                                          | Java, C#, Kotlin, Hermes for ReactNative, Languages that support WASM | Python, JavaScript, TypeScript, Ruby <br><br/>Strictly speaking though none of these are purely interpreted anymore. They all have evolved to have some sort of JIT compilation now. |
...
<img src="./assets/image-20251009001005631.png" alt="image-20251009001005631" style="zoom:50%;" />

##### TypeScript

TypeScript is not a compiled language in the sense that no machine code is produced during compile time, but its common practice to say that it undergoes through compilation. What that means is that during a 'compilation' phase, TyepScript code is type-checked for verification and then all the code is type-erased and a plain JS produced.

<img src="./assets/image-20251127113923506.png" alt="image-20251127113923506" style="zoom:50%;" />
...
ChatGPT [link](https://chatgpt.com/c/68aa464c-f298-832e-9739-7f194a2f0afe)

#### Interpreted languages are scarce now

Almost no mainstream modern language implementation is "strictly interpreted" anymore. Most have evolved to use bytecode, virtual machines, and/or JIT compilation. This includes JS, Python, Ruby, etc.

<img src="./assets/image-20260726183655636.png" alt="image-20260726183655636" style="zoom:50%;" />

ChatGPT [link](https://chatgpt.com/g/g-p-6a66554e47d08191981983576e2253f0-enterprise-apps-tooling/c/6a66557b-33a4-83ea-b340-9a4418b99872)
