...
function onOpen() {
  ...
  ui.createMenu('Custom Menu')
      .addItem('Populate Expenses', 'populateExpenses')
      .addItem('Summary Sheet - Update Selected Cells', 'updateSelectedCellsInSummarySheet')
      .addToUi();
}
```

![](assets/Misc-bc12521b.png)
...
```
const range1 = activeSpreadsheet.getSheetByName("Summary").getRange(1,3,1,20);
