...
![Claude-Code-Features](./assets/Claude-Code-Features.png)
...
###### What is Anthropic Console account used for

Some examples on how Anthropic Console account can be used in CICD. So basically connect to a server that has Claude using some keys and let it do things.

![image-20260321174649896](./assets/image-20260321174649896.png)

[ChatGPT link](https://chatgpt.com/g/g-p-698d2759efe081918edd9bc11bd1158a-claude-code/c/69be8902-c898-832a-8363-59e6a4ee2916)
...
> The generated plan md seems to be getting auto-saved in the path `~/.claude/plans`. <br> <br>![image-20260421124607848](./assets/image-20260421124607848.png)
