...
| Usual Claude account with subscription   | Anthropic Console account                                    | 3rd-party platform (Amazon Bedrock, Microsoft Foundry, etc.) |
| ---------------------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Used for the normal interactive sessions | Used for direct API access, for example if you want your CICD to directly talk with Claude in case of failures | Used by organizations, Claude is hosted in a 3rd party cloud and all the billing happens through it. |
...
There are ~3 modes of working in a session. Auto-accept all edits, Default (confirmation seeked every time for edits), Plan mode. You cycle between them using '**Shift + Tab**'. 
...
And then it finally asks what to do.
