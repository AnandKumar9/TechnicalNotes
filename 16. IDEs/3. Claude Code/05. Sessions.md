...
Its basically a persistent state that maintains conversations, information, and other settings across multiple Claude REPL invocations.
...
Once inside the Claude REPL, **/rename** can be used to set a name for the current session. 
