...
##### When are skills loaded

![image-20260322225847872](./assets/image-20260322225847872.png)
...
The below format can be used inside a SKILL.md to get dynamic content by running a shell command live. `!`  followed by shell command wrapped in backticks, i.e. (just like bash mode)
...
This can be done through **/permissions** or **permission rules**. ([Documentation](https://code.claude.com/docs/en/skills#restrict-claude’s-skill-access))
...
And these permissions can be made to apply to project level or user level.

<img src="./assets/image-20260224185217174.png" alt="image-20260224185217174" style="zoom:67%;" />