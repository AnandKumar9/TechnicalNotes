...
Various settings that are tweakable, can be changed at different levels - System wide for all users using it (enterprise owned), system wide for current user (user-managed), Project specific (user-managed but version controlled). Just like CLAUDE.md.
...
##### Scopes across various Claude Code features
