...
Note that Memory is just some general information, and not an exact comprehensive snapshot of a given state. Memories help Windsurf build some context, that's it.
...
There is just one global rules md file that can be there, and everything has to be put there. The file is physically located at `~/.codeium/windsurf/memories/global_rules.md`.
