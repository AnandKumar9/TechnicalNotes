...
Stanford deep learning course <br>

Better start with a course that uses ML libraries instead of building libraries from scratch, Udacity Intro to ML

Try ML on a real world dataset <br>
Code liner regression algorithm <br>Neural Network <br>Some NLP <br>
