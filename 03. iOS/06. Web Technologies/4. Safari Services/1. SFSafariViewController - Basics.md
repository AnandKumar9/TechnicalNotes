...
`SFSafariViewController` is a just like Safari web view controller that can be use in apps, and it automatically provides nearly every feature that Safari provides (including cookie access for webpages). 
