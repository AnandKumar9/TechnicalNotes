...
Around iOS14, WKWebView started supporting the Web API `getUserMedia()` ([this](https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/getUserMedia) thing) thereby allows WebRTC (real time media communications on web) functions to work inside the webview. 
