...
**Window** is a scene type for macOS and represents a single, unique window on all platforms. This common window is accessible through menu option 'Windows' and it has the verbiage provided in the method.
