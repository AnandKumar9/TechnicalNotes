...
>  @EnvironmentObject, .environmentObject() <br> EnvironmentValues, EnvironmentKey, and @Environment <br>

##### EnvironmentObject

> 👇 Possibly dated explanation as of 2024 (had actually noted this in 2021)
...
> 👇 Newer explanation as of 2024

If an object conforms to `ObservableObject` and `Observable` protocols, then any `@Published` property, can serve as the data source in a different View1's `@EnvironmentObject` property, with that View being embedded in another View2, and getting the object passed to it using an `environmentObject()` modifier.

![image-20240908212909699](/Users/anandkumar/Documents/Technical Notes/03. iOS/04. UI/2. SwiftUI/2. State and Data Management/assets/image-20240908212909699.png) 
