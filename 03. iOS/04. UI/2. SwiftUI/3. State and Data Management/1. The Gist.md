...
**ObservableObjet** is a protocol where any conforming type that has properties qualified with **@Published** wrapper automatically get a publisher named **objectWillChange** that publishes anytime one of those properties are about to change. <br>
