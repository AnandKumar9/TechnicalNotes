...
> 👉 Until iOS 16 (2022) the below were the norm for the purpose they serve, however since iOS 17 (2023) they have been replaced by Observation (i.e. `Observable` protocol/macro, `@Bindable` property wrapper).
