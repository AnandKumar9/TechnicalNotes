...
> The recommended naming conventioin is to not name async functions as beginning with a verb like get, etc. This is supposed to convey that a result may not be given right away (weird, but that's what they say in WWDC video).
