...
First have the static lib project, and then create **xcarchives** from it for both platforms (you could also do a build for both platforms and then grag hold of the generated .a from 'Derived Data', it is just that xcarchive is more clean as you don't need to look up Derived Data)
...
'Skip Install' being off ensures that while making xcarchive the library/framework is indeeded generated in the expected location in '.xcarchive/Products/...' (although why would it ever not I don't know).
