...
2. Set conditional paths in Build Settings → **Framework Search Paths** pointing to them. <br>
...
3. Add '-framework MyDynamicFramework' to Build Settings → **Other Linker Flags**. <br><br><img src="./assets/image-20260715230130840.png" alt="image-20260715230130840" style="zoom:33%;" />

4. Create a **Run Script** phase that itself does the **Embed & Sign** steps for the framework <br>
...
5. Turn off **User Script Sandboxing** which otherwise blocks certain steps in above script. <br><img src="./assets/image-20260715225956850.png" alt="image-20260715225956850" style="zoom:33%;" />
