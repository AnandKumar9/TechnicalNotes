...
Even a GitHub command line tool can be installed, which lets you work with Copilot in shell itself, i.e. ask questions, tell it to make edits in file right from shell.
