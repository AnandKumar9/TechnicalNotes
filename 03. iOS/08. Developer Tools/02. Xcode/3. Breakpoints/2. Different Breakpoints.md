...
That is where `Column breakpoint` comes in handy. It can be set by command-clicking on the expression to bring up the Actions popover and then setting it. And the column breakpoint can then be double clicked just like a normal line breakpoint.
