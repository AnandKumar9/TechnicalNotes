...
> Note that sometimes there may be multiple folders for same app, but only one of them will be the 'real deal' with .app, object files, etc. (and it will have several MBs in it). The other folders are mostly for things like test coverage results, etc. that Xcode may create and those will not have .app in their Build folder.
