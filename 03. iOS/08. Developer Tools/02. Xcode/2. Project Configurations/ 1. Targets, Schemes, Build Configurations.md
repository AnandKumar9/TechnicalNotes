...
There is a scheme, it can take several actions, those actions can be done on various run destiations. <br>Each of the actions has its set of targets/executables, configurations, and options.

![image-20240317134655935](assets/image-20240317134655935.png)
...
![image-20240317135001411](assets/image-20240317135001411.png)
...
A `Target` specifies the product to build. These can be an app (iOS, macOS, etc.), app extension, framework, or unit tests, or library/framework. Every target then contains the instructions for building the product from a set of files in a project to workspace and then finally performing a set of actions on those products. These build instructions are specified through different means, i.e. Build Settings, Build Phases, XCConfigs, etc.
...
In more build-specific theory, **Target** seems to be something that can compile a bunch of files. Its only essential output is a bunch of object files and does not look like it necessarily has to be executables, dylib, etc. as those can be generated

<img src="./assets/image-20260726141829753.png" alt="image-20260726141829753" style="zoom:50%;" />

[Official Documentation (link)](https://developer.apple.com/documentation/xcode/configuring-a-new-target-in-your-project) <br>[ChatGPT link](https://chatgpt.com/g/g-p-6934bcdfcafc819182baa9435e044320/c/6a5ccd4b-7a34-83ea-bcce-0fef2da508f7)
...
> So does an Aggregate Target have any use other than giving a way to ensure that certain targets are always built together.
