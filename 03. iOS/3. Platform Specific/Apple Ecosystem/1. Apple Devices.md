...
`iOS13` - 2019 <br>
`iOS12` - 2018 <br>
`iOS11` - 2017. iPad Dock. Drag and drop. Files app. Customizable Control Center. <br>
`iOS10` - 2016. Siri and stickers open to other apps. Home app. Richer notifications (lets you respond with text from lock screen, see video), Apple Pay on web. <br>
`iOS9` - 2015. Split view multi apps, slide over to other apps, picture in picture (small omnipresent video windows), News app. <br>
`iOS8` - 2014. Health app. Widgets in notification center, App extensions, External keyboards. Family sharing of store purchases. Shazam integration for Siri. ApplePay. HomeKit for developers. Handoff for continuing the same activity across iOS and Mac devices. Wifi calling, carrier’s phone services are not used for calling. <br>
`iOS7` - 2013. Totally revamped home screen and icons. Airdrop, control center by sliding up from bottom, swipe from left edge to go back navigation. iTunes radio. iBeacon. Spotlight accessible by swiping down instead of swiping left. <br>
`iOS6` - 2012. Had Passbook. Issues with the new Maps app. Youtube app didn’t come prepackaged anymore. Facebook integration. New podcasts app. <br>
`iOS5` - 2011. Had Siri, iCloud, folder system. iMessage, i.e. messages allowed to send messages to other iOS devices for free. Wireless sync. Twitter integration. Camera accessible from lock screen. Notification center. Push notifications. <br>
`iOS4` - 2010. iPhone OS renamed to iOS. Had multitasking for all apps. iBooks. <br>
`iPhone OS 3` - 2009. Push notifications. Copy and paste. MMS. <br>
