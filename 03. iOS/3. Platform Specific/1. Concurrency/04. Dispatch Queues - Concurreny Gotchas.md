...
> 'WWDC 2016: Concurrent Programming With GCD in Swift 3' 17:11 - 21:41 offers some GCD based tricks regarding how to avoid data races - using synchronous tasks, or using value types, or if object types have to be used then using some activation and invalidation pattern (with dispatch sources). 'WWDC 2015: Building Responsive and Efficient Apps with GCD' 25:09 - 28:14 too speaks about using serial queues to achieve synchronization locks and also how QoS interacts with it
