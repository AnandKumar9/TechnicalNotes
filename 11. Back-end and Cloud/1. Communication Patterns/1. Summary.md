...
6. **Publish–Subscribe** - Server broadcasts messages to multiple subscribers. In a way its same as 'Server →  Client Streaming' but generalizes it to many clients together. Apache Kafka, Redis Pub/Sub are some examples of this.
